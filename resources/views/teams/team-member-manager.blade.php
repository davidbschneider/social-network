    ...
    @if (Gate::check('addTeamMember', $team))
        ...
        <x-jet-form-section submit="addTeamMember">
            ...
            <x-slot name="description">
                {{ __('Add a new member to your group, allowing them to collaborate with you.') }}
            </x-slot>
            ...
            <x-slot name="form">
                ...
                <div class="mb-3">
                    {{ __('Please provide the email address of the person you would like to add to this group. The email address must be associated with an existing account.') }}
                </div>
